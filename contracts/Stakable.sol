...
/**
 * @notice Stakeable is a contract who is ment to be inherited by other contract
 * that wants Staking capabilities
 */
contract Stakable {
    /**
     * @notice
    ...
    /**
     * @notice
     * _Stake is used to make a stake for an sender. It will remove the amount staked
     * from the stakers account and place those tokens inside a stake container StakeID
     */
    ...
    /**
     * @notice
     * hasStake is used to check if a account has stakes and
     * the total amount along with all the seperate stakes
     */
